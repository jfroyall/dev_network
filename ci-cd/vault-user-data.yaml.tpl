...
# Demonstrate setting up an vault host on boot.
...
# Configure and run vault on boot



# Write a deploy key to the filesystem for vault.
# -------------------------------------------------
...
#
write_files:
  - path: /home/vault/.ssh/known_hosts
    owner: vault:vault
    permissions: 0o600
    defer: true
    content: |
  ...
  - path: /home/ansible/.ssh/id_rsa
    ...
    content: |
      ...
      -----END PRIVATE KEY-----
  - path: /home/vault/.ssh/id_rsa.pub
    owner: vault:vault
    permissions: 0o600
    defer: true
    content: |
